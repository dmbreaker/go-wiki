## This page has moved: https://golang.org/wiki/GoUsers ##
...
Also: [Organizations using Go](http://go-lang.cat-v.org/organizations-using-go) and [SuccessStories](SuccessStories.md)