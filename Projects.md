...
#### Other ####
  ...
  * [x2j](https://github.com/clbanning/x2j) - Unmarshal XML doc into map[string](string.md)interface{} or JSON
...
## Networking ##
  ...
  * [createsend-go](https://sourcegraph.com/github.com/sourcegraph/createsend-go/tree) - API client for [Monitor http://www.campaignmonitor.com](Campaign.md) (email campaign service)
